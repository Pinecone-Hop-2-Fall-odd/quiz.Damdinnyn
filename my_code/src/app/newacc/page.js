...
export default function Home() {
    ...
    return (
        <div className="bg-gradient-to-r from-violet-500 to-fuchsia-500 w-screen h-screen flex justify-center items-center">
            <div className="bg-white w-2/5 h-2/5 border-black border-[3px] rounded-2xl text-2xl flex flex-col justify-center items-center gap-6">
                ...
                <button onClick={() => login()} className="text-2xl bg-gradient-to-r from-violet-500 to-fuchsia-500 px-3 rounded-2xl">Бүртгэл үүсгэх</button>
            </div>
        </div>
    )
}